...
module.exports = {
  siteMetadata: {
    ...
    author: {
      name: `Nick Wisnewski`,
      summary: `Experienced, results-driven automation professional with a background in Cloud Engineering, DevOps, and Test Automation. Striving to solve problems for organizations throughout the software development life cycle. My IT career began in test automation, where I learned the importance of IAC and DevOps practices provisioning test environments for different regression scenarios. The progression to focusing more on DevOps was the natural next step. Located in Philadelphia, PA.`,
    },
